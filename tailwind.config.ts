	...
	theme: {
		...
		extend: {
			colors: {
				...
				'gradient-end': '#4299E1',    // Bright blue
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			backgroundImage: {
				...
				'hero-pattern': 'linear-gradient(to right bottom, rgba(107, 70, 193, 0.8), rgba(66, 153, 225, 0.8)), url("/neural-bg.png")',
			}
		}
	},
